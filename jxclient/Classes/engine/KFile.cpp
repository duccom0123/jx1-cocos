...
// 返回:	成功返回读取的字节数，失败返回0。
//---------------------------------------------------------------------------
unsigned long KFile::Read(void *lpBuffer,unsigned long dwReadBytes)
{
...
// 返回:	成功返回写入的字节数，失败返回0。
//---------------------------------------------------------------------------
unsigned long KFile::Write(void * lpBuffer, unsigned long dwWriteBytes)
{
...
//---------------------------------------------------------------------------
unsigned long KFile::Seek(long lDistance, unsigned long dwMoveMethod)
{
	//if (m_hFile == INVALID_HANDLE_VALUE)
	//	return SEEK_ERROR;
