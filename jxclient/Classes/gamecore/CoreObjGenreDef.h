...
#define CGOG_PLAYERSELLITEM		 12 // 摆摊买卖的东西
#define CGOG_IME_ITEM			 13  //快捷物品？
#define CGOG_SKILL_SHIQU		 14  //
#define CGOG_COM_ITEM		     15  //打造 图标显示 
#define CGOG_ITEM_SET            16  //
#define CGOG_CHESS_ITEM          17  //象棋
#define	CGOG_NPCSELLITEM_PAI	 18	// 拍卖行的东西
...
#define	CGOG_EQUIP_HORSE		CGOG_MAKE_DETAIL(CGOG_EQUIP, 10)	//装备-马
#define	CGOG_EQUIP_MASK			CGOG_MAKE_DETAIL(CGOG_EQUIP, 11)	//装备-面具
#define	CGOG_EQUIP_PIFENG		CGOG_MAKE_DETAIL(CGOG_EQUIP, 12)	//装备-披风
#define	CGOG_EQUIP_YINJIAN		CGOG_MAKE_DETAIL(CGOG_EQUIP, 13)	//装备-印鉴
#define	CGOG_EQUIP_SHIPIN		CGOG_MAKE_DETAIL(CGOG_EQUIP, 14)	//装备-饰品
