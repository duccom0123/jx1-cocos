...
{
	virtual void CoreDataChanged(unsigned int uDataId, unsigned int uParam, int nParam,int inVal=0) = 0;
...
{
	void CoreDataChanged(unsigned int uDataId, unsigned int uParam, int nParam,int inVal=0);
...
struct  iCoreShell
{
	...
	virtual int	 OperationRequest(unsigned int uOper, unsigned int uParam, int nParam,int nIsMianBan=0,char* strVal=NULL) = 0;
	//从游戏世界获取数据
	virtual int	 GetGameData(unsigned int uDataId, unsigned int uParam, int nParam,int inParam=0) = 0;
	...
	virtual int	TongOperation(unsigned int uOper, unsigned int uParam, int nParam,int vnParam=0,char *strParam=NULL) = 0;
	...
	virtual int  GetDataNpcShop(int nSaleId, unsigned int uParam, int nParam) = 0;
