...
#ifndef KObj_H
#define KObj_H
#define	MAX_OBJECT	256  //物品限制！！载入地图obj数据模板
#include "KIndexNode.h"  //后来增加的
...
#define		OBJ_BELONG_TIME		600         //捡别人东西的时间设置
...
public:
	...
	int         m_IsHaveAttack;         //是否设置为攻击无效了
	DWORD       m_AttackerDwid;         //上次攻击着的DWID
    DWORD       m_AttackerTime;         // 恢复的时间
