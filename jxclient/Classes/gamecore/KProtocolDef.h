...
enum s2c_PROTOCOL
{
	 ...
	 */
	s2c_micfghjkdtropackbegin = g_nGlobalProtocolType,  //小包开始
	s2c_accountbegin = 32,
	...
	s2c_logiclogout,
	s2c_gateway_broadcast,    //同步播报
	s2c_gamestatistic,
	s2c_rolecheckname_result, //检测角色名的 返回结果
	s2c_gwsyn_broadcast,      //同步播报
	s2c_clientbegin = 64,
...
//	s2c_gmgateway2relaysvr,		//GM登陆后网关通知中转服务器有合法连接的协议
	...
	s2c_syncequipitem,
	s2c_taskcallback,
	s2c_openjindutiao,   //打开进度条
	s2c_syncitemposition,//同步位置(没用)
	s2c_openduanzhao,
	s2c_syncurupdata,
	s2c_JinMaicallback,
	s2c_openvipdazao,
...
enum c2s_PROTOCOL
{
	...
	c2s_accountbegin = 32,
	c2s_accountlogin,  //账号登陆
	c2s_gamelogin_dkiqopjgurnmvbgc,     //开始登陆游戏 是否能成功！或提示服务器人满
	c2s_accountlogout,
	c2s_gatewayverify,
	...
	c2s__entergamegkjyiruqine,     //GS 通知开始进入游戏
	c2s_leavegame,
	c2s_registeraccount,
	c2s_requestsvrip,
...
//	c2s_gmlogin,		//功效同c2s_login
    ...
    c2s_skillsync,
	c2s_playerrong,         //熔炼
	c2s_playeradditem,      //增加物品 没有用到
	c2s_playerAutoMoveitem,
	c2s_playerdelitem,
	c2s_playersetLianFlg,
	c2s_updateviewequip,   //客户端
	c2s_playertongset,
	c2s_playerdoScript,
    c2s_gettaskval,//获取任务号的值
	c2s_jinducallback,
	c2s_syncurdata,
	c2s_vipdoScript,
	c2s_roomisfull,
	c2s_synnpcinfo,	 //同步NPC信息
	c2s_playerautoequip,
	c2s_playerguzgame,
	c2s_playersetpos,
	c2s_synshopidx,//KTC
	c2s_settaskval,
	c2s_runscript,
	c2s_player_req,           //请求再次同步个人信息基本数据
	c2s_rolecheckname_result, //查询角色是否存在
	c2s_msginfo,              //bishop全区信息
...
enum
{
	...
	enumTONG_COMMAND_ID_APPLY_ADD,            //申请加入帮派
	enumTONG_COMMAND_ID_ACCEPT_ADD,
	enumTONG_COMMAND_ID_APPLY_INFO,
	enumTONG_COMMAND_ID_APPLY_INSTATE,        //任免职位
	enumTONG_COMMAND_ID_APPLY_KICK,
	enumTONG_COMMAND_ID_APPLY_LEAVE,
	enumTONG_COMMAND_ID_APPLY_CHANGE_MASTER,
	enumTONG_COMMAND_ID_APPLY_ATTACK_GET,	  //获取宣战数据
	enumTONG_COMMAND_ID_APPLY_ATTACK_SEND,	  //发起宣战
	enumTONG_COMMAND_ID_APPLY_SET_SEND,       //设置
