...
class KuiInPutIp:public CCLayer{
public: 
	KuiInPutIp();
	~KuiInPutIp();
	//初始化
	...
	static KuiInPutIp * create(CCObject * callbackListener,SEL_CallFuncN callfun);
...
private:
	...
	//执行上层对象的回调函数，关闭弹出框
	void buttonCallBackFunc(CCObject * pSender,int ver);
